...
const projects = [
  {
    ...
    description: 'Webseite der Firma für Montage und Handel von Industrierobotern.',
    image: herrlesNord,
    link: 'https://herrles-nord.de/'
  },
  {
    title: 'Alte Fabrik Studios',
    description: 'Webseite des Fotostudios in Altenburg – Vermietung kreativer Räume.',
    image: alteFabrik,
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    {projects.map((project, i) => (
      ...
      >
        ...
        {/* Titel */}
        <h2 className="text-2xl md:text-3xl font-semibold text-white mb-2">{project.title}</h2>

        {/* Beschreibung */}
        <p className="text-gray-300 text-base md:text-lg mb-2">{project.description}</p>
